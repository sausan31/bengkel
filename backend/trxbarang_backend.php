...
$sql = "SELECT trxbarang.*, barangjasa.*, supplier.* FROM trxbarang, barangjasa, supplier WHERE trxbarang.id_brg=barangjasa.id_brg AND trxbarang.id_spl=supplier.id_spl ORDER BY trxbarang.tgl_trxbrg DESC";
